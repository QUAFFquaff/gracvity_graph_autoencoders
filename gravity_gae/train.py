...
from gravity_gae.draw_result import draw_result_html
...
flags.DEFINE_string('dataset', 'mydata', 'Name of the graph dataset')
''' Available datasets:
...
- mydata: input the data generated by make_data.py
'''
...
adj_init, features, graph, feature_arr = load_data('mydata')
    ...
    for epoch in range(FLAGS.epochs):
        ...
        if FLAGS.verbose:
            ...
            if FLAGS.validation and FLAGS.task == 'task_1':
                ...
                feed_dict.update({placeholders['dropout']: FLAGS.dropout})
                val_roc, val_ap, preds, preds_neg = compute_scores(val_edges, val_edges_false, emb)
